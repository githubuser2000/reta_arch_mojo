...
| `retaPrompt.py` | 130 | 10 | 0 | 3 | weitgehend nativ | `src/prompt_main.mojo + src/reta_mojo/prompt_runtime.mojo + prompt_language.mojo` | Controller, Sitzungskern, Kurzsprache, Completion und explizite native One-shots nativ; noch nicht portierte Fachoperationen sowie historische Kurz-Echos gehen unverändert an die Bridge |
