...
| `reta_architecture/concat_csv.py` | 305 | 18 | 2 | 0 | teilweise nativ | `src/reta_mojo/generated_table_columns.mojo + prime_universe_columns.mojo + assets/fraction_pairs.tsv` | `PrimCSV` und die für Primuniversum benötigten Bruchrelationen nativ; allgemeine CSV-Verkettung folgt in Stufe 8 |
...
| `reta_architecture/generated_columns.py` | 2010 | 38 | 3 | 0 | weitgehend nativ | `src/reta_mojo/generated_columns.mojo + generated_table_columns.mojo + prime_cross_columns.mojo + prime_effect_columns.mojo + prime_universe_columns.mojo` | sämtliche über die Aliasmatrix erreichbaren Generatorbefehle sowie Modal-, Mond-, Vielfachen- und Klassifikationspfade nativ; allgemeine Metaspalten bleiben getrennt offen |
...
| `reta_architecture/meta_columns.py` | 977 | 24 | 2 | 0 | teilweise nativ | `scripts/generate_fraction_pair_catalog.py + src/reta_mojo/prime_universe_columns.mojo` | exakte Bruchmengen-/Relationslogik wird reproduzierbar extrahiert und zur Laufzeit nativ ausgewertet; allgemeine Meta-Konkret/Abstrakt-Spalten sind offen |
