...
| `reta_architecture/prompt_execution.py` | 2516 | 24 | 1 | 3 | weitgehend nativ | `src/reta_mojo/prompt_fraction_execution.mojo + prompt_table_execution.mojo + prompt_runtime.mojo + prompt_main.mojo` | Bruchparser, historische Bruchbereiche, Quotientenachsen, Primfaktorenvergleich, Zwei-Bereichs-Abstände, 18 Tabellenfamilien, Null-/Negativselektoren, kollidierende All-Zeilen-Ausschlüsse, Bruchteiler und Reziprok-Vielfache nativ; echte `v n/m`-Vielfache, doppelte generierte Spalteninstanzen und weitere Sonderzweige bleiben Bridge |
