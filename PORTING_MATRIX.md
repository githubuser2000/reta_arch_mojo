...
| `retaPrompt.py` | 130 | 10 | 0 | 3 | weitgehend nativ | `src/prompt_main.mojo + src/reta_mojo/prompt_runtime.mojo + prompt_language.mojo + prompt_legacy_echo.mojo` | Controller, Sitzungskern, Kurzsprache, Completion, explizite One-shots und sämtliche kompakte Tabellenfamilien mit bytegenauem Legacy-Echo nativ; reine Zahlenkompositionen und noch nicht portierte Fachoperationen gehen unverändert an die Bridge |
