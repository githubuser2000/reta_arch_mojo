...
- Native Mojo-Quellzeilen unter `src/`: **16340**
...
| `mojo_bridge.py` | 396 | 20 | 0 | 0 | Systemgrenze | `src/prompt_completion_main.mojo + python_reference/mojo_bridge.py` | Python verwaltet Readline, Pipes und Fallbackprozesse; Completion und Kurzsprache laufen im persistenten Mojo-Arbeiter |
...
| `retaPrompt.py` | 130 | 10 | 0 | 3 | weitgehend nativ | `src/prompt_main.mojo + src/reta_mojo/prompt_runtime.mojo + prompt_language.mojo` | Controller, Sitzungskern, Kurzsprache und Completion nativ; noch nicht portierte Fachoperationen gehen unverändert an die Bridge |
...
| `reta_architecture/prompt_execution.py` | 2516 | 24 | 1 | 3 | weitgehend nativ | `src/reta_mojo/prompt_fraction_execution.mojo + prompt_table_execution.mojo + prompt_runtime.mojo + prompt_main.mojo` | Bruchparser, historische Bruchbereiche, Quotientenachsen, Primfaktorenvergleich, Zwei-Bereichs-Abstände, 18 Tabellenfamilien, stabile Ausschlüsse, Bruchteiler und Reziprok-Vielfache nativ; echte `v n/m`-Vielfache, kollidierende All-Zeilen-Ausschlüsse und weitere Sonderzweige bleiben Bridge |
...
| `reta_architecture/prompt_runtime.py` | 158 | 9 | 4 | 1 | weitgehend nativ | `src/reta_mojo/prompt_runtime.mojo + prompt_table_execution.mojo + prompt_main.mojo` | native Kernbefehle, Profile, Primfaktorenvergleich, Abstände sowie ganzzahlige und positive gebrochen-rationale Tabellen-Ausführungspläne; verbleibende Sonderbefehle bleiben Bridge |
