...
| `retaPrompt.py` | 130 | 10 | 0 | 3 | weitgehend nativ | `src/prompt_main.mojo + src/reta_mojo/prompt_runtime.mojo + prompt_language.mojo + prompt_legacy_echo.mojo` | Controller, Sitzungskern, Kurzsprache, Completion, explizite One-shots und rendererstabile kompakte Legacy-Echos nativ; rendererempfindliche Kurzformen und noch nicht portierte Fachoperationen gehen unverändert an die Bridge |
...
| `reta_architecture/prompt_runtime.py` | 158 | 9 | 4 | 1 | weitgehend nativ | `src/reta_mojo/prompt_runtime.mojo + prompt_table_execution.mojo + prompt_legacy_echo.mojo + prompt_main.mojo` | native Kernbefehle, Profile, `mulpri`, Primfaktorenvergleich, Abstände, kompakte Legacy-Präsentation sowie ganzzahlige und gebrochen-rationale Tabellenpläne; verbleibende Sonderbefehle bleiben Bridge |
