...
| `retaPrompt.py` | 130 | 10 | 0 | 3 | weitgehend nativ | `src/prompt_main.mojo + reta_mojo/prompt_runtime.mojo + terminal_geometry.mojo` | Controller, One-shots, Sitzungszustand, Befehls-/Tabellenframing und dynamische TTY-Breite nativ; interaktive Eingabe und Restfallback bleiben Bridge |
...
| `reta_architecture/prompt_execution.py` | 2516 | 24 | 1 | 3 | weitgehend nativ | `src/reta_mojo/prompt_* + prompt_main.mojo` | zentrale Kurzsprache, Tabellenplanung, numerische Fachbefehle und One-shots nativ; echte v-n/m-Restzweige und hintere Fallbacks offen |
