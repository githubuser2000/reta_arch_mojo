...
| `reta_architecture/prompt_execution.py` | 2516 | 24 | 1 | 3 | weitgehend nativ | `src/reta_mojo/prompt_fraction_execution.mojo + prompt_table_execution.mojo + prompt_runtime.mojo + prompt_main.mojo` | Bruchparser, historische Bruchbereiche, Quotientenachsen, Primfaktorenvergleich, Zwei-Bereichs-Abstände, 18 Tabellenfamilien und ganzzahlige Vielfachen/Teiler nativ; Bruchausschlüsse, Bruch-plus-Modifikator und weitere Sonderzweige bleiben Bridge |
