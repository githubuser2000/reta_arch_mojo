...
| `reta_architecture/arithmetic.py` | 273 | 19 | 1 | 0 | nativ | `src/reta_mojo/arithmetic.mojo + parallel_execution.mojo` | arithmetischer Kern sowie thread-/prozessbasierte Chunkausführung für Primfaktoren und Faktorpaare nativ |
...
| `reta_architecture/parallel_execution.py` | 1076 | 53 | 6 | 10 | nativ | `src/reta_mojo/parallel_execution.mojo + parallel_row_preparation.mojo + beide Parallel-CLIs` | Auto-Modus nutzt Mojo-CPU-Threads ohne GIL; zehn reine Tabellen-/Zahlenkerne besitzen Thread- und optionale Linux-fork-Backends; der dynamische WorkerPrepare/deepcopy-Pfad ist durch einen besitzenden typisierten Zeilenkontext ersetzt |
