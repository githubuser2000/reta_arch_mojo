...
NATIVE = {
    ...
    "reta_domain_probe_py.py": ("teilweise nativ", "src/domain_probe_main.mojo + bin/reta-mojo-domain-probe", "neun zentrale Inspektionsbefehle für Hauptparameter, Unterparameter, kanonische Paare, direkte Spalten, Rückabbildung sowie kompakte JSON-Ausgaben nativ; HTML-Metadaten und vollständige Architektursnapshots bleiben getrennte Besitzergrenze"),
