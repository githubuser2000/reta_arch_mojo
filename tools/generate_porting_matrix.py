...
NATIVE = {
    ...
    "reta_architecture/arithmetic.py": ("nativ", "src/reta_mojo/arithmetic.mojo + parallel_execution.mojo", "arithmetischer Kern sowie thread-/prozessbasierte Chunkausführung für Primfaktoren und Faktorpaare nativ"),
