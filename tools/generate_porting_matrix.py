...
NATIVE = {
    ...
    "retaPrompt.py": ("weitgehend nativ", "src/prompt_main.mojo + src/reta_mojo/prompt_interaction.mojo", "alle öffentlichen Promptlauncher aktivieren den nativen Controller; nur ausdrücklich unbesessene hintere Befehle wechseln atomar in den Python-Referenzkindprozess"),
    ...
    "reta_architecture/generated_columns.py": ("weitgehend nativ", "src/reta_mojo/generated_columns.mojo + generated_table_columns.mojo + prime_cross_columns.mojo + prime_universe_columns.mojo + table_runtime.mojo", "vollständige typisierte Registry-, Bundle-, Snapshot- und öffentliche Besitzeroberfläche in Python-Reihenfolge; die zehn Morphismen delegieren auf ihre bereits nativen algorithmischen Besitzer, während die dynamische Concat-Objektintegration als verbleibende Kompatibilitätsgrenze gilt"),
