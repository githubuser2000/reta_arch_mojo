...
NATIVE = {
    ...
    "libs/LibRetaPrompt.py": ("weitgehend nativ", "src/reta_mojo/prompt_runtime.mojo + completion_runtime.mojo + prompt_language.mojo + prompt_session.mojo + prompt_interaction.mojo", "Importzeit-Bundles, Vokabular, Completion, Sitzung und Controller sind nativ; die historische Python-Reexportoberfläche bleibt Referenz"),
