...
printf '%s\n' 'stage12c1/c2/c3/c4a/c4b/c4c/c4d/c4e/c4f/c4g/c4h/c4i/c4j/c4k/c4l terminal-width, native TTY editor, raw-command, fallback-child, bridge-free compatibility, portable Mojo runtime, native output-stream/markup-oneTable/no-blank-contents/paginated-rendering/column-widths/raw-nocolor-markup, reciprocal and classic-fraction tests complete'
