...
printf '%s\n' 'stage12c1/c2/c3/c4a/c4b/c4c/c4d/c4e/c4f/c4g terminal-width, native TTY editor, raw-command, fallback-child, bridge-free compatibility, native output-stream/markup-oneTable, reciprocal and classic-fraction tests complete'
