...
expected='reta-mojo-native reta-mojo-table reta-mojo-tags reta-mojo-i18n reta-native reta-mojo-compat-bin reta-prompt-native reta-prompt-complete grundStrukHtml-native generate-html-native'
