...
expected='reta-mojo-native reta-mojo-table reta-mojo-tags reta-native reta-mojo-compat-bin reta-prompt-native grundStrukHtml-native generate-html-native'
