...
## --columns
    ...
    * --human= 
        * human-animal,kriminell,goetter,Sinne,Superpowers,formations,views,directions,Satan_Devil,bestrafen,diplomatie,punishment,less_at_human,Salvation,violence,Zeitalter,Himmel_Hoelle_Kettenmolekuele,Spiele-Genre,Land_Laender-Dach-Organisation,raenge,class,morality,specialties,senseandmeaningoflife,intelligenceproblems,way_of_thinking_of_living_beings,countertranscendentals,equalityfreedom,emotions,egoism,effect,incel,irrationalNumbersbyrooting,dominantgender,love,faith,vulnerability,sadist,affiliations,motifs,positions,consciousness,achievements,evolutionary_acquire_and_intelligence,need,disease,alphabeta,anfuehrer_und_boss,biological_tree_(15),manipulation,jobs,solutions,music,honest,konservativ,Professioneller,managen,intelligent_Design,karriere,elite
    * --macht= 
        * cluster,formen,orbit,struktur,sun,galaxy,abstrakt,Speziesherrschaftsformen,planet
    * --MetaMetaPhysik_und_MetaChemie= 
        * Meta_Meta_Physik_Einteilungen,kybernetik
    * --universe= 
        * winkel,logik,objekt,evolution_vs_design_intelligent,Spezies_Entwicklung,particles_other_universe,context_brain_cosmos_universe,zahlen,colors,artificiallife,software_license,strategy,ratioSameNumber,law,combineetc,breedingup,particle-meta-physics,metaparadigmreligion,spherescircles,analyticontology,countertranscendentals,systemthings,transcendentals,transcendentalreciprocal,network,whytranscendentalstructuralsizeandcharacter,category,space,programmingparadigms,mind,whyTranscendentalEqualsComplexity,modelofhierarchicalcomplexity,spezies,biological_tree_(15),morphismus
    * --planet= 
        * logik,kreislauf,herrschaft,truthRealities,metasystems,intelligence,equality,complexity,mechanisms
    * --religions= 
        * Superpowers,religionfoundertype,Satan_Devil,hinduism,starpolygon,ofthezodiac,compare,messiah,uniformpolygon,representativehigherconcepts
    * --galaxy= 
        * Superpowers,living_creatures_galaxy_best_at,revelation,breedingup,spherescircles,chinesehoroscope,zodiacsigns,gospelofthomas,analyticontology,insideOutsideStructure,modallogic,ZergAliens_MenschenHumanoid_ProtosPraedatoren,space
    ...
    * --multiverse= 
        * farbe,Computer,kybernetik,particles_other_universe,space_time_arrangement_mathematically_universal,multiversalias,particles,modelofhierarchicalcomplexity,transcendentals,mind,structure_sciences_(10),pattern_sciences_(20),biological_tree_(16_->_15),Religionen_Kraefte_Krieg_der_Sterne_Star_Wars,p,p5
    * --basic_structures= 
        * particles_other_universe,punishment,Salvation,violence,network,controversy,mathematicaldesign,analyticontology,scale,modelofhierarchicalcomplexity,system,transcendentals,condition,areas_of_life,measures,relativereciprocal,universalcomparative,existentials,extremalia,expectations,passion,relativetimeamount,numericalcomparison,aspiration,principles,attractions,optimization,topics,meaning,reciprocal,attention,time,intention16,intention17,intention6,intention7,awareness,behavior,energy,sheafs,comprehend,empathy,intention1/6,innervalues,intention10,well-being,mind,reflex,lust,paradigms,truthRealities,calculate,mood,leadership_types_(7),class,order,metasystems,intention1pro8,goals,concreta,emotions,dependence,map,foundation,positions,imaginations,shall,views,affiliations,intention13,love,coalitions,against_5,impulses,drive,actions,reflection,states,biological_tree_(15)
    * --particles= 
    ...
    * --gebrochengalaxie_fractionalgalaxy= 
        * 9,23,8,5,10,15,17,7,11,22,14,4,16,12,2,13,21,6,3,20,18,19
    ...
    * --fractionalnumberedstructuresize= 
        * 9,23,8,5,10,15,17,7,11,22,14,4,16,12,2,13,21,6,3,20,18,19
    * --symbols= 
        * religions,Three,Four,Fife,Six,Seven,Eight,Nine,Ten,Twelve
    * --properties= 
