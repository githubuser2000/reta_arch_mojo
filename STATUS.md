...
- Stufe 9: **BBCode und zentrale HTML-Pfade nativ; Shell-/Restformatierung offen**
...
- Nativer Mojo-Quellcode in `src/`: **13.304 Zeilen**
...
- farbige Shellausgabe, Terminalbreiten und Rich-spezifische Sonderfälle
