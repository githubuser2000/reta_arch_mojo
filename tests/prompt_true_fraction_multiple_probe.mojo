...
def main() raises:
    ...
    _emit("emotion universum v 1/2,2/3")
    _emit("mond universum v2/3")
    _emit("mond universum motive v2/3")
    _emit("mond richtung primzahlkreuz alles thomas universum v2/3")
    _emit("mond universum motive v2/3,5")
    _emit("mond universum motive v2/3,5 teiler")
    _emit("mond emotion universum v2/3,5")
    _emit("mond richtung primzahlkreuz alles thomas universum motive v2/3,5")
    _emit("universum v2/3,5")
    _emit("universum v2/3,1 teiler")
    ...
    _emit("emotion universum v 1/2,2/3,5")
    ...
    _emit("universum v2/3,0,-10")
    _emit("universum v2/3,5-7,-6")
    _emit("universum motive v2/3 -10")
    ...
    _emit("universum v 1/4,-1/8,2/3")
    _emit("v universum 1/4,-1/8,2/3")
    _emit("universum 1/4,-1/8,2/3 v")
    _emit("universum vielfache 1/4,-1/8,2/3")
    _emit("emotion universum v1/4,-1/8,2/3")
    _emit("emotion universum v 1/4,-1/8,2/3")
