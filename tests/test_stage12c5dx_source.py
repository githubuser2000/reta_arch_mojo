...
def test_current_stage_points_to_dx() -> None:
    ...
    if "test_stage12c5ee.sh" in current or "test_stage12c5ed.sh" in current:
        return
    assert "test_stage12c5dx.sh" in current or "test_stage12c5ea.sh" in current or "test_stage12c5dy.sh" in current or "test_stage12c5ea.sh" in current or "test_stage12c5dz.sh" in current or "test_stage12c5ea.sh" in current
